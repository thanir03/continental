...
const benefits: Benefit[] = [
  ...
  { id: '2', icon: 'restaurant', text: 'Members get 20% discount for restaurant services' },
  { id: '3', icon: 'phone-portrait', text: 'Take advantage of Mobile Check-in and Mobile Keys' },
...
const BenefitFlatList: React.FC = () => {
  return (
    <View style={styles.content}>
      <FlatList
        data={benefits}
        renderItem={({ item }) => <BenefitItem icon={item.icon} text={item.text} />}
